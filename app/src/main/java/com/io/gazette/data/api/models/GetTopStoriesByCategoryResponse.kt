package com.io.gazette.data.api.models
...
enum class ItemType(val value: String) {
    ...
    companion object : KSerializer<ItemType> {
        override val descriptor: SerialDescriptor get() {
            return PrimitiveSerialDescriptor("com.io.gazette.data.api.models.ItemType", PrimitiveKind.STRING)
        }
        override fun deserialize(decoder: Decoder): ItemType = when (val value = decoder.decodeString()) {
            "Article"     -> Article
            "Interactive" -> Interactive
            "Promo"       -> Promo
...
enum class Kicker(val value: String) {
    ...
    companion object : KSerializer<Kicker> {
        override val descriptor: SerialDescriptor get() {
            return PrimitiveSerialDescriptor("com.io.gazette.data.api.models.Kicker", PrimitiveKind.STRING)
        }
        override fun deserialize(decoder: Decoder): Kicker = when (val value = decoder.decodeString()) {
            ""                      -> Empty
...
enum class Format(val value: String) {
    ...
    companion object : KSerializer<Format> {
        override val descriptor: SerialDescriptor get() {
            return PrimitiveSerialDescriptor("com.io.gazette.data.api.models.Format", PrimitiveKind.STRING)
        }
        override fun deserialize(decoder: Decoder): Format = when (val value = decoder.decodeString()) {
...
enum class Subtype(val value: String) {
    ...
    companion object : KSerializer<Subtype> {
        override val descriptor: SerialDescriptor get() {
            return PrimitiveSerialDescriptor("com.io.gazette.data.api.models.Subtype", PrimitiveKind.STRING)
        }
        override fun deserialize(decoder: Decoder): Subtype = when (val value = decoder.decodeString()) {
            "photo" -> Photo
...
enum class Type(val value: String) {
    ...
    companion object : KSerializer<Type> {
        override val descriptor: SerialDescriptor get() {
            return PrimitiveSerialDescriptor("com.io.gazette.data.api.models.Type", PrimitiveKind.STRING)
        }
